...
public class Main {
    ...
    public static String getPromptedInput(String prompt, String[] validResponses) { //outputs text and reliably returns the response
        ...
        do {
            ...
            if (output.equals("")) {
                //if they've inputted something they shouldn't, explain that
    ...
    public static void endGame() {
        ...
        if (gameMode.equals("c"))
            System.out.println("You are sentenced to " + playerOneScore + " years, I am sentenced to " + computerScore + " years.");
        if (gameMode.equals("m"))
            System.out.println(playerOneName + " is sentenced to " + playerOneScore + " years. " + playerTwoName + " is sentenced to " + playerTwoScore + " years.");
